...
class CompanyWebsiteList extends StatelessWidget {
  final List<CompanyWebsite> websites;
  final Color lightColor;

  const CompanyWebsiteList({Key? key, required this.websites, required this.lightColor}) : super(key: key);
  ...
  Widget _buildWebsiteIcon(CompanyWebsite website) {
    IconData iconData;
    Color iconColor;
