...
class GameTimeToBeat extends Equatable {
  ...
  String? get hastilyFormatted =>
      hastilyHours != null ? '${hastilyHours!.toStringAsFixed(1)} hours' : null;
  String? get normallyFormatted => normallyHours != null
      ? '${normallyHours!.toStringAsFixed(1)} hours'
      : null;
  String? get completelyFormatted => completelyHours != null
      ? '${completelyHours!.toStringAsFixed(1)} hours'
      : null;
