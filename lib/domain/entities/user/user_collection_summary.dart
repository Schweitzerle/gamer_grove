...
class UserCollectionSummary extends Equatable {
  ...
  // Helper getters
  String get mostPlayedGenre => genreBreakdown.isNotEmpty
      ? genreBreakdown.entries.reduce((a, b) => a.value > b.value ? a : b).key
      : 'Unknown';

  String get mostUsedPlatform => platformBreakdown.isNotEmpty
      ? platformBreakdown.entries
          .reduce((a, b) => a.value > b.value ? a : b)
          .key
      : 'Unknown';

  int get mostActiveYear => yearBreakdown.isNotEmpty
