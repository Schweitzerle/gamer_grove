...
class GetCompleteEventDetails
    extends UseCase<CompleteEventDetails, GetCompleteEventDetailsParams> {
  ...
  @override
  Future<Either<Failure, CompleteEventDetails>> call(
      GetCompleteEventDetailsParams params) async {
    try {
      // Get event details
      ...
      return Left(
          ServerFailure(message: 'Failed to load complete event details: $e'));
    }
  }
}
